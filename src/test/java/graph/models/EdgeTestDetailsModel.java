...
/**
 * EdgeTestDetailsModel defines the information to check in a GraphML output string for an edge element.
 * 
...
@Data
@Builder
public class EdgeTestDetailsModel {
	...
	private String lineStyleType;
	private String edgeLabelBackgroundColor;
	private String edgeLabelValue;
